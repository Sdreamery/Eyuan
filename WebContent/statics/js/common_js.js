...
$('#Recharge_btn').on('click', function(){
   layer.open({
        ...
        content: '\<\div style="padding:20px;" class="select_style"><a href="http://www.baidu.com" class="Recharge_btn"><img src=statics/images/zhifu1_10.png /></a><a href="#" class="Recharge_btn"><img src=statics/images/zhifu1_07.png /></a><a href="#" class="Recharge_btn"><img src=statics/images/zhifu1_12.png /></a>\<\/div>'
    });
});
//产品边框样式
