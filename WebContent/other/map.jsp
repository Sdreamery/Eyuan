...
%>
	...
	<div class="Navigation" id="Navigation">
		 <ul class="Navigation_name">
			...
			<li><a href="#">热销活动</a></li>
			<li class="on"><a href="/eyuan/other/map.jsp">联系我们</a></li>
		 </ul>			 
		</div>
    	...
    	<div style=" width:100px; height:100px;float: right;text-align: center;">
 		<input name="" type="button" onclick="located()" style="margin-left: -100px; width:100px; height:100px;  border:0; background:url(/eyuan/statics/img/mapmarker.png) no-repeat left top;background-size:contain;" />
 		<h2 style="margin-left: -100px">定位我们</h3>
 		</div>
	...
	myPoint = new BMap.Point(121.252785,31.02241);//初始点
	map.centerAndZoom(myPoint, 13);
	map.enableScrollWheelZoom(true);
	var myIcon = new BMap.Icon("/eyuan/statics/img/mapmarker.png", new BMap.Size(300,157));
	var marker = new BMap.Marker(myPoint,myPoint);//初始点设置标志
	map.addOverlay(marker);
	marker.setLabel(new BMap.Label("总部：上海尚学堂",{offset:new BMap.Size(20,-10)}));
	...
	map.addEventListener("click", function(e){ //鼠标点击事件       
		...
		myGeo.getLocation(pt, function(rs){
			...
			if(addComp.street.trim()!=null||addComp.street.trim()!=""){
				bdGEO(add);
			}
	...
	function bdGEO(add){//标点
		myGeo.getPoint(add, function(point){
			if (point) {
				...
				transit.search(address,myPoint);
			}
		}, "上海市");
	}
	// 编写自定义函数,创建标注
